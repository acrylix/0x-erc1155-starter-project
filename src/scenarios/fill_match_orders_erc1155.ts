...
export async function scenarioAsync(): Promise<void> {
    PrintUtils.printScenario('Match Orders ERC1155');
    ...
    const zrxTokenAddress = '0x0361C62c52bB12Bb1B79e8988F3CCA8dF3DF00a5';
    const etherTokenAddress = '0x0361C62c52bB12Bb1B79e8988F3CCA8dF3DF00a5';
    ...
    const makerAssetData = assetDataUtils.encodeERC1155AssetData(
        zrxTokenAddress,
        new Array(3).fill('').map((_, i) => getBig(i + 1)),
        new Array(3).fill('').map(_ => getBig(1)),
        '0x',
    );
